...
export interface IRewardDefinitions {
    ...
    addListener(eventName: RewardAdPluginEvents.FailedToLoad, listenerFunc: (error: AdError) => void): PluginListenerHandle;
    addListener(eventName: RewardAdPluginEvents.Loaded, listenerFunc: (info: AdLoadInfo) => void): PluginListenerHandle;
    addListener(eventName: RewardAdPluginEvents.Rewarded, listenerFunc: (reward: AdRewardItem) => void): PluginListenerHandle;
    addListener(eventName: RewardAdPluginEvents.Dismissed, listenerFunc: () => void): PluginListenerHandle;
    addListener(eventName: RewardAdPluginEvents.FailedToShow, listenerFunc: (error: AdError) => void): PluginListenerHandle;
